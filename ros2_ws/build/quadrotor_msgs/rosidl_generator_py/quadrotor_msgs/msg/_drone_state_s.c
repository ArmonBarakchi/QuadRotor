...
bool quadrotor_msgs__msg__drone_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._drone_state.DroneState", full_classname_dest, 42) == 0);
  }
  quadrotor_msgs__msg__DroneState * ros_message = _ros_message;
  {  // header
...
PyObject * quadrotor_msgs__msg__drone_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadrotor_msgs.msg._drone_state");
  ...
  {  // omega
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "omega");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->omega[0]);
    memcpy(dst, src, 3 * sizeof(double));
    Py_DECREF(field);
  }
  {  // gyro_bias
